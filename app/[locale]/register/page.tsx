            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="space-y-2 pt-1">
                <p className="text-xs font-semibold text-[#225D5C]">
                  ...
                  <label className="group relative flex h-16 w-16 cursor-pointer items-center justify-center overflow-hidden rounded-full border-2 border-[#E9E2D8] bg-[#F2E8DC] md:bg-[#FFD6A8]/30 shadow-md transition-all hover:border-[#225D5C]/50">
                      {logo ? (
